...
const OurNewsAndArticles = () => {
  ...
  const articles = [
    {url: "/newsDetails", image: article_news1, alt: "A picture of a woman sitting in a class room.", day: "25", month: "Mar",  
    ...
    {url: "/newsDetails", image: article_news2, alt: "An image of the first page of ChatGPT.", day: "17", month: "Mar",  
    ...
    {url: "/newsDetails", image: article_news3, alt: "A photograph of books about programming stacked on top of each other.", day: "13", month: "Mar",  
    ...
    {url: "/newsDetails", image: article_news4, alt: "A picture of people sitting down taking notes from what looks like a seminar.", day: "12", month: "Mar",  
    ...
    {url: "/newsDetails", image: article_news5, alt: "A photograph of an office landscape.", day: "07", month: "Mar",  
    ...
    {url: "/newsDetails", image: article_news6, alt: "A photograph of modern looking office landscape.", day: "02", month: "Mar",  
    ...
    {url: "/newsDetails", image: article_news7, alt: "A photograph of a laptop with business intelligence software running.", day: "28", month: "Feb",  
    ...
    {url: "/newsDetails", image: article_news8, alt: "A picture of apple products in rose gold.", day: "18", month: "Feb",  
    ...
    {url: "/newsDetails", image: article_news9, alt: "A photograph of an open notebook and some office supplies.", day: "11", month: "Feb",  
